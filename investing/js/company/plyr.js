!function (e, t) {
  ...
  "use strict";
  function n() {
    var e, n, a, r = navigator.userAgent, s = navigator.appName, o = "" + parseFloat(navigator.appVersion), i = parseInt(navigator.appVersion, 10);
  ...
  function i(e, t) {
    ...
    for (var n = e.length - 1; n >= 0; n--) {
      var a = n > 0 ? t.cloneNode(!0) : t, r = e[n], s = r.parentNode, o = r.nextSibling;
  ...
  function g(e, t, n, a, r) {
    var s = t.split(" ");
    if ("boolean" != typeof r && (r = !1), e instanceof NodeList)for (var o = 0; o < e.length; o++)e[o] instanceof Node && g(e[o], arguments[1], arguments[2], arguments[3]); else for (var i = 0; i < s.length; i++)e[a ? "addEventListener" : "removeEventListener"](s[i], n, r)
  }
  ...
  function T() {
    ...
    if ("undefined" != typeof t.cancelFullScreen)e.supportsFullScreen = !0; else for (var a = 0, r = n.length; r > a; a++) {
  ...
  function _(g, x) {
    ...
    function N() {
      var e = [], t = F(), n = (t.external ? "" : t.url) + "#" + x.iconPrefix;
    ...
    function L(e) {
      var n = V(x.selectors.captions), a = t.createElement("span");
    ...
    function B(e) {
      ...
      if (!Be.usingTextTracks && "video" === Be.type && Be.supported.full && (Be.subcount = 0, e = "number" == typeof e ? e : Be.media.currentTime, Be.captions[Be.subcount])) {
        for (; a(Be.captions[Be.subcount][0]) < e.toFixed(1);)if (Be.subcount++, Be.subcount > Be.captions.length - 1) {
    ...
    function W() {
      ...
      var t = H("input:not([disabled]), button:not([disabled])"), n = t[0], a = t[t.length - 1];
      y(Be.container, "keydown", e)
    }

    function Y(e, t) {
      if ("string" == typeof t)d(e, Be.media, {src: t}); else if (t.constructor === Array)for (var n = t.length - 1; n >= 0; n--)d(e, Be.media, t[n])
    }
    ...
    function q() {
      ...
      var a;
      if (null !== x.selectors.controls.container && (a = x.selectors.controls.container, "string" == typeof selector && (a = t.querySelector(a))), a instanceof HTMLElement || (a = Be.container), a.insertAdjacentHTML("beforeend", n), x.tooltips.controls)for (var r = H([x.selectors.controls.wrapper, " ", x.selectors.labels, " .", x.classes.hidden].join("")), s = r.length - 1; s >= 0; s--) {
        var i = r[s];
    ...
    function se(e) {
      var t = 0, n = Be.media.paused, a = oe();
    ...
    function Ae(t) {
      var n = x.volumeMax, a = x.volumeMin;
    ...
    function ge(e) {
      if (Be.supported.full) {
        var t = Be.progress.played, n = 0, a = oe();
        if (e)switch (e.type) {
          case"timeupdate":
          case"seeking":
    ...
    function Ee(e) {
      ...
      if (x.tooltips.seek && Be.progress.container && 0 !== t) {
        var n = Be.progress.container.getBoundingClientRect(), a = 0, r = x.classes.tooltip + "--visible";
        if (e)a = 100 / n.width * (e.pageX - n.left); else {
    ...
    function Ie() {
      function n() {
        ...
        e ? ee() : te();
        var t = Be.buttons[e ? "play" : "pause"], n = Be.buttons[e ? "pause" : "play"];
      ...
      function a() {
        ...
        for (var n in Be.buttons) {
          var a = Be.buttons[n];
          if (a instanceof NodeList)for (var r = 0; r < a.length; r++)m(a[r], x.classes.tabFocus, a[r] === e); else m(a, x.classes.tabFocus, a === e)
        }
      }
  ...
  function S(e) {
    var a, r, s = n(), o = "IE" === s.name && s.version <= 9, i = /iPhone|iPod/i.test(navigator.userAgent), l = !!t.createElement("audio").canPlayType, u = !!t.createElement("video").canPlayType;
    switch (e) {
      case"video":
        a = u, r = a && !o && !i;
        break;
